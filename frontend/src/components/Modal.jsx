...
const Modal = ({
  ...
  return (
    <div onScroll={() => {ReactTooltip.rebuild();}} className="modal-outer-container">
      ...
      <ReactTooltip className="modal-tooltip" effect="solid" type="info" place="bottom" backgroundColor='#79A4F7' textColor='#202124' />
    </div>
  );
};
